Feature: Blog post
  ...
  Examples:
    ...
    | news/csp-alive-and-well-america                                                        | CSP is alive and well in America!          | <strong>SolarReserve </strong>                                                                           | Solar Energy | Bea Gonzalez        |
    | news/project-lom-pangar-30-mw-hydroelectric-dam                                        | Cameroon - Project Lom Pangar:             | Project Lom Pangar: donors reveal their intentions. This article presents the results of the round       |              | Zaira Girbau Garcia |
    | news/caroline-jackson-join-waste-management-forum-speaker                              | Caroline Jackson to join the Waste Management forum as a speaker| <p><strong>John P. Foden</strong> will speak about the                              |              | Via Expo            |
